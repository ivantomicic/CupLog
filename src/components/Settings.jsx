...
export default function Settings() {
  ...
  return (
    <div>
      ...
      {error && <div>{error}</div>}
      {resetSent && <div>Password reset email sent! Please check your inbox.</div>}
          ...
          {hasEmailAuth && (
            <div>
              ...
              <div>
                ...
                <p>Click the button above to receive a password reset email.</p>
              </div>
            </div>
          )}

          <button onClick={handleSave} disabled={!avatarFile || saving}>
