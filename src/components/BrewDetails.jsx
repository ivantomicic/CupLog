...
export default function BrewDetails() {
  ...
  const selectedRoastDate = brew.coffee?.roast_dates?.find(rd => rd.id === brew.roast_date_id);
    ...
    <div>
      ...
      {isEditing ? (
        <div>
          <div>
            <label>
              ...
              <select
                ...
                onChange={(e) => setEditedBrew({ ...editedBrew, coffee_id: e.target.value })}
                disabled // Disable changing coffee for now as it requires reloading roast dates
              >
                <option value={brew.coffee?.id}>{brew.coffee?.name}</option>
              </select>
            </label>
          </div>

          {brew.coffee?.roast_dates && brew.coffee.roast_dates.length > 0 && (
            <div>
              <label>
                Roast Date:
                <select
                  value={editedBrew.roast_date_id}
                  onChange={(e) => setEditedBrew({ ...editedBrew, roast_date_id: e.target.value })}
                >
          ...
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedBrew({ ...editedBrew, date: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <select
                ...
                onChange={(e) => setEditedBrew({ ...editedBrew, grinder_id: e.target.value })}
                disabled // Disable for now as we need to load all grinders
              >
                <option value={brew.grinder?.id}>{brew.grinder?.name}</option>
              </select>
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedBrew({ ...editedBrew, grind_size: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <select
                ...
                onChange={(e) => setEditedBrew({ ...editedBrew, brewer_id: e.target.value })}
                disabled // Disable for now as we need to load all brewers
              >
                <option value={brew.brewer?.id}>{brew.brewer?.name}</option>
              </select>
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedBrew({ ...editedBrew, brew_time: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedBrew({ ...editedBrew, dose: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedBrew({ ...editedBrew, yield: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <textarea
                ...
                onChange={(e) => setEditedBrew({ ...editedBrew, notes: e.target.value })}
                rows="4"
              />
            </label>
          </div>
          <div>
            ...
            {editedBrew.image_url && (
              <div>
                <p>Current image:</p>
                <img src={editedBrew.image_url} alt="Current brew" style={{ maxWidth: '200px' }} />
              </div>
            )}
          </div>
          <div>
            ...
            {editedBrew.flow_chart_url && (
              <div>
                ...
                <img src={editedBrew.flow_chart_url} alt="Flow chart" style={{ maxWidth: '200px' }} />
              </div>
            )}
          </div>
        ...
        <div>
          ...
          <p>Roast Date: {
            selectedRoastDate 
              ? new Date(selectedRoastDate.date).toLocaleDateString() 
              : 'Unknown'
          }</p>
          ...
          {brew.image_url && (
            <div>
              <h3>Brew Image</h3>
              <img src={brew.image_url} alt="Brew" style={{ maxWidth: '300px' }} />
            </div>
          )}
          ...
          {brew.flow_chart_url && (
            <div>
              <h3>Flow Chart</h3>
              <img src={brew.flow_chart_url} alt="Flow chart" style={{ maxWidth: '300px' }} />
            </div>
          )}
