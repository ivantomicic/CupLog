...
import { getCoffees, updateCoffee, createRoastDate, deleteRoastDate } from '../utils/supabase-queries';
          ...
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedCoffee({ ...editedCoffee, name: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedCoffee({ ...editedCoffee, country: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedCoffee({ ...editedCoffee, region: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedCoffee({ ...editedCoffee, farm: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedCoffee({ ...editedCoffee, altitude: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <select
                ...
                onChange={(e) => setEditedCoffee({ ...editedCoffee, roast: e.target.value })}
              >
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0 }}>
          {(coffee.roast_dates || [])
            ...
            .map(roastDate => {
              const isClosest = roastDate === getClosestRoastDate(coffee.roast_dates);
              return (
                <li 
                  key={roastDate.id}
                  style={{ 
                    ...
                    marginBottom: '8px',
                    padding: '8px',
                    backgroundColor: isClosest ? '#e6f3ff' : '#f5f5f5',
                    borderRadius: '4px'
                  }}
                >
                  <span>
                    {new Date(roastDate.date).toLocaleDateString()}
                    {isClosest && <span style={{ marginLeft: '8px', color: '#0066cc' }}>(Latest)</span>}
                  </span>
                  {isEditing && (
                    <button
                      onClick={() => handleDeleteRoastDate(roastDate.id)}
                      style={{ 
                        marginLeft: 'auto',
