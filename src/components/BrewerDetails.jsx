...
export default function BrewerDetails() {
  ...
  return (
    <div>
      <button onClick={() => navigate('/brewers')}>Back to Brewers</button>
          ...
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedBrewer({ ...editedBrewer, name: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedBrewer({ ...editedBrewer, material: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <select
                ...
                onChange={(e) => setEditedBrewer({ ...editedBrewer, type: e.target.value })}
              >
