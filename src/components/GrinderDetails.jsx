...
export default function GrinderDetails() {
  ...
  return (
    <div>
      <button onClick={() => navigate('/grinders')}>Back to Grinders</button>
          ...
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedGrinder({ ...editedGrinder, name: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedGrinder({ ...editedGrinder, burr_size: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedGrinder({ ...editedGrinder, burr_type: e.target.value })}
              />
            </label>
          </div>
          <div>
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditedGrinder({ ...editedGrinder, ideal_for: e.target.value })}
              />
            </label>
          </div>
